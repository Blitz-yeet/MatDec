...
def main() -> None:
    ...
    # Service loads (SLS for deflection) – here taken equal to ULS for V1
    q_SLS = 15.0   # kN/m
    P_SLS = 30.0   # kN
    ...
    data_path = base_dir / "data" / "materials.csv"

    db = MaterialsDB(data_path)

    # Use all profiles from the materials table as candidates
    ...
    print("\n=== Candidate beams (passing bending + deflection) ===")
    ...
    if not passing_sorted:
        ...
        print(
            ...
            f"(limit {deflection_limit_mm:.1f} mm) | "
